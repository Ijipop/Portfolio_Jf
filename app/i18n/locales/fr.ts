...
export const fr = {
    ...
    homeV2: {
      ...
      caseTimelendrContext: 'Planifier et synchroniser sans tableur illisible.',
      caseTimelendrDeliverable: 'App desktop Windows et macOS — timeline collaborative.',
      caseTimelendrResult: 'Outil concret pour équipes qui livrent à l’heure.',
      caseTimelendrCta: 'Découvrir Timelendr',
      caseSpaceTakerTitle: 'Space Taker',
      caseSpaceTakerContext: 'Disque plein, dossiers obscurs — besoin de voir vite ce qui pèse.',

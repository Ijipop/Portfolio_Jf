...
export const en = {
    ...
    homeV2: {
      ...
      caseTimelendrContext: 'Planning and syncing without an unreadable spreadsheet.',
      caseTimelendrDeliverable: 'Windows and macOS desktop app — collaborative timeline.',
      caseTimelendrResult: 'A practical tool for teams that ship on time.',
      caseTimelendrCta: 'Discover Timelendr',
      caseSpaceTakerTitle: 'Space Taker',
      caseSpaceTakerContext: 'Full disk, opaque folders — need to see what takes space fast.',

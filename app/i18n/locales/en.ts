...
export const en = {
    ...
    homeV2: {
      ...
      caseStudiesLead: 'Context, deliverable, result — from SMB sites to desktop tools.',
      ...
      credibilityLocalBody:
        'Remote across Quebec, in person on Montreal Island. I handle everything from start to finish.',
